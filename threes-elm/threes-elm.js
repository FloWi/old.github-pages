...
var author$project$ThreesDraw$init = function (_n0) {
	return _Utils_Tuple2(
		{board: author$project$ThreesDraw$initialBoard, showDetails: true},
					...
					return A2(
						...
						F2(
							function (colIdx, cell) {
								return {col: colIdx, row: rowIdx, value: cell};
							}),
						row);
				}),
			board));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Threes$getIndexedBoard(model.board))
			]));
};
var author$project$ThreesDraw$boardAreaDiv = function (model) {
	var divs = A2(
		...
		model.showDetails ? author$project$ThreesDraw$boardAnalysisDivs(model) : _List_Nil);
	var cssClassName = model.showDetails ? 'board-area-with-details' : 'board-area-without-details';
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$ThreesDraw$ToggleShowDetails = {$: 'ToggleShowDetails'};
		...
		model.showDetails ? _List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						author$project$Threes$boardToString(model.board))
					]))
			]) : _List_Nil);
	return A2(
		elm$html$Html$div,
